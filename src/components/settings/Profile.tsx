    ...
    <SettingsCardContainer title='پروفایل' Icon={CiUser}>
      <div className="flex flex-col sm:flex-row items-center gap-4 mb-6">
        ...
        <div className="flex flex-col gap-1 sm:gap-3 text-center sm:text-right">
          ...
          <span className="text-gray-500 text-sm">amiramraja@gmail.com</span>
        </div>
      </div>
     <div className="flex justify-center sm:justify-start" >
     <button className="bg-indigo-600 hover:bg-indigo-700 rounded transition duration-200 text-white font-dana-medium py-2 px-4">
        ویرایش پروفایل
      </button>
     </div>
